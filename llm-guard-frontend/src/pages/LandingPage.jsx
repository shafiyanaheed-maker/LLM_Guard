...
function SectionHeading({
  ...
  return (
    <div className="mx-auto max-w-2xl text-center mb-14">
      <div
        className={`inline-flex h-10 w-10 items-center justify-center rounded-xl ${a.badge}`}
      >
      ...
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 light:border-slate-200 bg-white/[0.03] light:bg-white text-slate-300 light:text-slate-600 transition-all duration-200 hover:bg-white/[0.06] light:hover:bg-slate-50 hover:text-white light:hover:text-slate-900"
          >
            {isLight ? (
              <Moon size={18} />
            ) : (
        ...
        <div className="md:hidden flex items-center gap-2">
          ...
          <button
            ...
            aria-label="Toggle dark and light mode"
            title={isLight ? "Switch to dark mode" : "Switch to light mode"}
            className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 light:border-slate-200 bg-white/[0.03] light:bg-white text-slate-300 light:text-slate-600 transition-all duration-200"
          >
            {isLight ? (
              <Moon size={18} />
            ) : (
          ...
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/[0.03] light:bg-white border border-white/10 light:border-slate-200 text-slate-300 light:text-slate-600 transition-all duration-200 hover:bg-white/[0.06] light:hover:bg-slate-50"
          >
            {open ? (
              <X size={20} />
            ) : (
  ...
  const detected = [
    {
      ...
      icon: CheckCircle2,
      cls: "text-red-400 bg-red-500/10 border-red-400/20",
    },
    {
      label: "Jailbreak Attempt",
      icon: CheckCircle2,
      cls: "text-orange-400 bg-orange-500/10 border-orange-400/20",
    },
    {
      label: "Sensitive Data Risk",
      icon: CheckCircle2,
      cls: "text-amber-400 bg-amber-500/10 border-amber-400/20",
    },
  ];
      ...
      <div className="relative overflow-hidden rounded-2xl bg-white/[0.03] light:bg-white border border-white/10 light:border-slate-200 backdrop-blur-sm shadow-glow">
        ...
        <div className="flex items-center justify-between border-b border-white/5 light:border-slate-200 px-5 py-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="text-sm font-semibold text-white light:text-slate-900 leading-none">
                LLM Guard
              </p>
          ...
          <div className="space-y-2 mb-3">
            ...
            {detected.map((item) => {
              ...
              return (
                <div
                  key={item.label}
                  className={`flex items-center gap-2.5 rounded-lg ${item.cls} px-3 py-2`}
                >
                  <Icon
                    size={14}
                    className="shrink-0"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          ...
          {FEATURES.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className={`group relative overflow-hidden rounded-2xl bg-white/[0.03] light:bg-white border border-white/10 light:border-slate-200 p-6 transition-all duration-200 ${accent.hover} hover:-translate-y-0.5 hover:bg-white/[0.06] light:hover:bg-slate-50`}
              >
                ...
                <div
                  className={`inline-flex h-11 w-11 items-center justify-center rounded-xl ${accent.badge}`}
                >
                  <Icon
                ...
                <p className="mt-2 text-sm text-slate-400 light:text-slate-500 leading-relaxed">
                  {feature.desc}
                </p>
              ...
              >
                ...
                {index < STEPS.length - 1 && (
                  <div className="hidden lg:flex absolute top-1/2 -right-4 z-10 items-center justify-center">
                    <ArrowRight
                      className="text-slate-600 light:text-slate-400"
                      size={18}
                    />
                  </div>
                )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
          ...
          {WHY.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className={`group relative overflow-hidden rounded-2xl bg-white/[0.03] light:bg-white border border-white/10 light:border-slate-200 p-6 sm:p-8 transition-all duration-200 ${accent.hover} hover:-translate-y-0.5 hover:bg-white/[0.06] light:hover:bg-slate-50`}
              >
                ...
                <div
                  className={`inline-flex h-12 w-12 items-center justify-center rounded-xl ${accent.badge}`}
                >
                  <Icon
                    className={accent.icon}
                    size={24}
  ...
  const miniStats = [
    {
      label: "Requests",
      value: "1,248",
      valueCls: "text-white light:text-slate-900",
    },
    {
      label: "Blocked",
      value: "156",
                ...
                <div className="hidden sm:block w-40 shrink-0 border-r border-white/5 light:border-slate-200 p-3">
                  ...
                  <div className="pt-3 space-y-1">
                    ...
                    <div className="flex items-center gap-2 rounded-md bg-cyan-500/10 border border-cyan-400/20 px-2 py-1.5">
                      ...
                      <LayoutDashboard
                        className="text-cyan-300 light:text-cyan-600"
                        size={12}
                      />

                      <span className="text-[11px] font-medium text-cyan-300 light:text-cyan-600">
                        Dashboard
                      </span>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    {miniStats.map((stat) => (
                      ...
                      >
                        ...
                        <p
                          className={`text-lg font-bold tabular-nums ${stat.valueCls}`}
                        >
                          {stat.value}
                        </p>
